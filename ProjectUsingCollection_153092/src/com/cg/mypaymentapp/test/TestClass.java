...
public class TestClass {
	...
	public void setUp() throws Exception{
		...
		Customer cust1=new Customer("Ravi", "9866837576",new Wallet(new BigDecimal(9000)));
		Customer cust2=new Customer("Teja", "9491955395",new Wallet(new BigDecimal(6000)));
		Customer cust3=new Customer("Chinni", "9652665470",new Wallet(new BigDecimal(7000)));
	...
	public void testCreateAccount6() {
		service.createAccount("Ravi", "9866837576", new BigDecimal(-100));
	}
	@Test
	public void testCreateAccount7() {
		Customer actual=service.createAccount("Bhargav", "8754922472", new BigDecimal(0));
		Customer expected=new Customer("Bhargav", "8754922472", new Wallet(new BigDecimal(0)));
		assertEquals(expected, actual);
	}
	@Test
	public void testCreateAccount8() {
		Customer actual=service.createAccount("Shiva", "8754922472", new BigDecimal(5000.75));
		Customer expected=new Customer("Shiva", "8754922472", new Wallet(new BigDecimal(5000.75)));
		assertEquals(expected, actual);
	}
	@Test(expected=InvalidInputException.class)
